...
<div class="container my-auto">
    <form action="add_exist.php" method="POST">
        <div id='kitapDiv' class="container">
            ...
            <div style="justify-content: center; display: flex; align-items: center; flex-direction: column;">
                <div>
                    <button id='topluKaydet' name='existbook-btn' type="submit" class="btn btn-primary mt-3 align-center">Kaydet</button>
                </div>
                ...
                <div>
                    <a href="add.php" class="btn btn-primary mb-3 float-right"
                        title="İstediğiniz kitap kütüphanede yoksa ekleyin !">Yeni bir kitap ekle</a>
                </div>
            </div>
